...
import kizuki.ac.features.checks.impl.aim.*;
import kizuki.ac.features.checks.impl.analysis.*;
import kizuki.ac.features.checks.impl.aura.*;
import kizuki.ac.features.checks.impl.autoclicker.*;
import kizuki.ac.features.checks.impl.fastclimb.*;
import kizuki.ac.features.checks.impl.flight.*;
import kizuki.ac.features.checks.impl.hand.*;
import kizuki.ac.features.checks.impl.hitbox.*;
import kizuki.ac.features.checks.impl.inventory.*;
import kizuki.ac.features.checks.impl.jesus.*;
import kizuki.ac.features.checks.impl.motion.*;
import kizuki.ac.features.checks.impl.move.*;
import kizuki.ac.features.checks.impl.packet.*;
import kizuki.ac.features.checks.impl.phase.*;
import kizuki.ac.features.checks.impl.scaffold.*;
import kizuki.ac.features.checks.impl.speed.*;
import kizuki.ac.features.checks.impl.timer.*;
import kizuki.ac.features.checks.impl.velocity.*;
